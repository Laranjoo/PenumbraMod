...
{
	public class CorrosionHookProjectile2 : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Vector2 origin = new Vector2(7, 9); // Offset for where the player's hand will start measured from the top left of the image.
                float scale = 1;
                ...
                if (i == list.Count - 2)
                {
                    ...
                    frame.Height = 38; // Height of the frame.
    ...
    public class CorrosionHookProjectile3 : ModProjectile
    {
        public override string Texture => "PenumbraMod/Content/Items/CorrosionHookProjectile2";
        public override void SetStaticDefaults()
        {
            // This makes the projectile use whip collision detection and allows flasks to be applied to it.
            ProjectileID.Sets.IsAWhip[Type] = true;
