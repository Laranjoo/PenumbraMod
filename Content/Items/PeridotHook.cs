...
{
	internal class PeridotHook : ModItem
	{
		public override void SetDefaults() {
			// Copy values from the Amethyst Hook
			Item.CloneDefaults(ItemID.AmethystHook);
			Item.shootSpeed = 14f; // This defines how quickly the hook is shot.
			Item.shoot = ModContent.ProjectileType<PeridotHookProjectile>(); // Makes the item shoot the hook's projectile when used.
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<Placeable.Peridot>(15)
				.AddTile(TileID.Anvils)
				.Register();
		}
	}

	internal class PeridotHookProjectile : ModProjectile
	{
		...
		public override void Load() { // This is called once on mod (re)load when this piece of content is being loaded.
			...
			chainTexture = ModContent.Request<Texture2D>("PenumbraMod/Content/Items/PeridotHookChain");
		}
