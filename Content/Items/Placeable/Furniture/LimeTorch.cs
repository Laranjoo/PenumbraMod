...
namespace PenumbraMod.Content.Items.Placeable.Furniture
{
    public class LimeTorch : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToTorch(ModContent.TileType<Tiles.LimeTorch>(), 0, false);
            Item.value = 50;
        }
        ...
        public override void HoldItem(Player player)
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(new Vector2(player.itemLocation.X + (player.direction == -1 ? -16f : 6f), player.itemLocation.Y - 14f * player.gravDir), 4, 4, ModContent.DustType<Content.Dusts.LimeTorch>(), 0f, 0f, 100);
            ...
            Lighting.AddLight(position, 0.182f, 1.246f, 0.180f);
        }
        ...
        public override void PostUpdate()
        {
            ...
            if (!Item.wet)
            {
                Lighting.AddLight(Item.Center, 0.182f, 1.246f, 0.180f);
            }
        }
