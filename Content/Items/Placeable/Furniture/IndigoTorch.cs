...
namespace PenumbraMod.Content.Items.Placeable.Furniture
{
    public class IndigoTorch : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToTorch(ModContent.TileType<Tiles.IndigoTorch>(), 0, false);
            Item.value = 50;
        }
        ...
        public override void HoldItem(Player player)
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(new Vector2(player.itemLocation.X + (player.direction == -1 ? -16f : 6f), player.itemLocation.Y - 14f * player.gravDir), 4, 4, ModContent.DustType<Content.Dusts.IndigoTorch>(), 0f, 0f, 100);
                dust.velocity *= 0.3f;
            ...
            Lighting.AddLight(position, 0.108f, 0.189f, 1.248f);
        }
        ...
        public override void PostUpdate()
        {
            ...
            if (!Item.wet)
            {
                Lighting.AddLight(Item.Center, 0.108f, 0.189f, 1.248f);
            }
        }
