...
{
	public class AquamarineGemcorn : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Plants.AquamarineTreeSapling>(), 2);
			Item.width = 12;
			Item.height = 14;
			Item.value = 1200;
		}
		...
		public override void AddRecipes() {
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<Aquamarine>())
				.Register();
		}
	}
}
