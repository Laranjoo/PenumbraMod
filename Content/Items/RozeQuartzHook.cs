...
{
	internal class RozeQuartzHook : ModItem
	{
		public override void SetDefaults() {
			// Copy values from the Amethyst Hook
			Item.CloneDefaults(ItemID.AmethystHook);
			Item.shootSpeed = 11f; // This defines how quickly the hook is shot.
			Item.shoot = ModContent.ProjectileType<RozeQuartzHookProjectile>(); // Makes the item shoot the hook's projectile when used.
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<Placeable.RozeQuartz>(15)
				.AddTile(TileID.Anvils)
				.Register();
		}
	}

	internal class RozeQuartzHookProjectile : ModProjectile
	{
		...
		public override void Load() { // This is called once on mod (re)load when this piece of content is being loaded.
			...
			chainTexture = ModContent.Request<Texture2D>("PenumbraMod/Content/Items/RozeQuartzHookChain");
		}
