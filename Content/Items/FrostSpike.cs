...
namespace PenumbraMod.Content.Items
{
	public class FrostSpike : ModProjectile
	{
        ...
        public override void AI()
		{
            ...
            int dust = Dust.NewDust(Projectile.position + -Projectile.velocity, Projectile.width, Projectile.height, DustID.IceRod, Projectile.oldVelocity.X * 2f, Projectile.oldVelocity.Y * 2f, Scale: 1f);
