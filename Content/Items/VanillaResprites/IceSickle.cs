...
namespace PenumbraMod.Content.Items.VanillaResprites
{
    public class IceSickle : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("PenumbraMod/Content/Items/VanillaResprites/IceSickleef").Value;
    ...
    public class IceSickleExplosion : ModProjectile
    {
        public override string Texture => "PenumbraMod/Content/Items/VanillaResprites/IceSickle";
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Ice Sickle"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            ProjectileID.Sets.CultistIsResistantTo[Projectile.type] = false;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < Main.rand.Next(3, 4); i++)
            {
                ...
                Projectile.NewProjectileDirect(Projectile.InheritSource(Projectile), Projectile.Center, velocity, ProjectileID.Blizzard, Projectile.damage / 2, 2, Projectile.owner);
            }
            // This code and the similar code above in OnTileCollide spawn dust from the tiles collided with. SoundID.Item10 is the bounce sound you hear.
            Collision.HitTiles(Projectile.position + Projectile.velocity, Projectile.velocity, Projectile.width, Projectile.height);
            SoundEngine.PlaySound(SoundID.Item27, Projectile.position);
