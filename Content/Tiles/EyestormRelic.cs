...
namespace PenumbraMod.Content.Tiles
{
	...
	public class EyestormRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "PenumbraMod/Content/Tiles/EyestormRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "PenumbraMod/Content/Tiles/RelicPedestal";
