...
namespace PenumbraMod.Content.Tiles
{
	...
	public class PurpleTorch : ModTile
	{
		...
		public override void SetStaticDefaults() {
			...
			DustType = ModContent.DustType<Content.Dusts.PurpleTorch>();
			...
			*/
			...
			// Etc
			AddMapEntry(new Color(248, 181, 243), Language.GetText("ItemName.Torch"));

			// Assets
			if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("PenumbraMod/Content/Tiles/PurpleTorch_Flame");
			}
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
			...
			Color color = new Color(248, 181, 243, 0);
			int width = 20;
			int height = 20;
