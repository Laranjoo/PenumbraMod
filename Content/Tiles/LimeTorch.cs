...
namespace PenumbraMod.Content.Tiles
{
	...
	public class LimeTorch : ModTile
	{
		...
		public override void SetStaticDefaults() {
			...
			DustType = ModContent.DustType<Content.Dusts.LimeTorch>();
			...
			*/
			...
			// Etc
			AddMapEntry(new Color(182, 246, 180), Language.GetText("ItemName.Torch"));

			// Assets
			if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("PenumbraMod/Content/Tiles/LimeTorch_Flame");
			}
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
			...
			Color color = new Color(182, 246, 180, 0);
			int width = 20;
			int height = 20;
