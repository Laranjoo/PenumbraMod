...
namespace PenumbraMod.Content.Tiles
{
	...
	public class IndigoTorch : ModTile
	{
		...
		public override void SetStaticDefaults() {
			...
			DustType = ModContent.DustType<Content.Dusts.IndigoTorch>();
			...
			*/
			...
			// Etc
			AddMapEntry(new Color(108, 189, 248), Language.GetText("ItemName.Torch"));

			// Assets
			if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("PenumbraMod/Content/Tiles/IndigoTorch_Flame");
			}
		}
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
			...
			Color color = new Color(108, 189, 248, 0);
			int width = 20;
			int height = 20;
